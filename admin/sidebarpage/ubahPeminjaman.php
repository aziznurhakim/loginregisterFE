...
$peminjaman = query("SELECT * FROM peminjaman WHERE id = $id")[0];
if(isset($_POST["submit"])){
if(ubahPinjaman($_POST) > 0){
    echo "
    <script>
      ...
      <form action="#" method="POST">
        ...
        <input type="hidden" name="id" value="<?= $peminjaman["id"]; ?>">
          <div class="input-box">
            ...
            <input type="text" name="judul_buku" placeholder="Masukkan Judul Buku" value="<?= $peminjaman["judul_buku"]; ?>" required>
          </div>
          <div class="input-box">
            <span class="details">Nama Siswa</span>
            <input type="text" name="nama_siswa" placeholder="Masukkan Nama Siswa" value="<?= $peminjaman["nama_siswa"]; ?>" required>
          </div>
          <div class="input-box">
